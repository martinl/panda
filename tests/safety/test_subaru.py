...
def lkas_tx_msgs(alt_bus):
  return [[MSG_SUBARU_ES_LKAS,          SUBARU_MAIN_BUS], 
          ...
          [MSG_SUBARU_Throttle,         SUBARU_CAM_BUS],
...
class TestSubaruSafetyBase(common.PandaSafetyTest, common.DriverTorqueSteeringSafetyTest):
  ...
  FWD_BLACKLISTED_ADDRS = {SUBARU_MAIN_BUS: [MSG_SUBARU_Throttle, MSG_SUBARU_Brake_Pedal], SUBARU_CAM_BUS: [MSG_SUBARU_ES_LKAS, MSG_SUBARU_ES_DashStatus, MSG_SUBARU_ES_LKAS_State, MSG_SUBARU_ES_Infotainment]}
